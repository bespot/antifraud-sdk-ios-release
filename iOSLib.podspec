...
Pod::Spec.new do |spec|
  ...
  spec.name         = "iOSLib"
  spec.version      = "0.0.1"
  spec.summary      = "Bespot Safe SDK fraud prevention platform."
  ...
  Bespot Safe SDK is a highly customisable online-fraud prevention solution that detects suspicious activities is the dependency in mobile and web applications.
                   DESC
...
#  spec.source_files  = "iOSLib/**/*.swift"
  #spec.exclude_files = "Classes/Exclude"

  #spec.public_header_files = "iosLib/**/*.h"
