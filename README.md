...
```
.package(url: "https://github.com/bespot/antifraud-sdk-ios-release.git", exact: "1.2.1")
```
...
target '[Your app]' do
  ...
  pod 'AntifraudSDK', :git => 'https://github.com/bespot/antifraud-sdk-ios-release', :tag => '1.2.1'
...
public enum SDKError: String, Error {
    case networkConnection, // Connection Error
         ...
         quotaReachedForPlan, // The account has reached the request quota of its current plan
         ...
         alreadyInitialized, // The SDK has already been initialized
